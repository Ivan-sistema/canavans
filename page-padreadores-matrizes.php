<?php /* template name: Padreadores e matrizes */ ?>
...
<section>
    ...
    query_posts( array( 'post_type' => 'post', 'showposts' => 8, 'paged'=>$paged, 'category_name'=>'padreadores-matrizes'));
		...
		<a  href="https://www.instagram.com/canavans.s/" target="_blank"><i class="fab fa-instagram"></i></a>
						...
						<div class="btn-ver geral-btn"><a href="<?php the_permalink(); ?>">Veja + <i class="fas fa-paw"></i></a></div>
